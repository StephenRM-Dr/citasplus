...
return [
    ...
    | requests. By default, we will use the "file" session driver but you
    | may specify any of the other wonderful drivers listed here.
    |
    ...
    */
    ...
    | the PHP OpenSSL extension with the Illuminate Encrypter.
    |
    */
